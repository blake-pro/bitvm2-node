...
* operator-wrapper-proof: wraps operator proof and exposes `operator_vk_hash_raw`, `graph_id_padded`, and `genesis_sequencer_commit_txid` as public inputs for Challenge.
