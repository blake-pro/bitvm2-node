...
pub(crate) mod v1 {
    ...
    pub(crate) const PROOFS_PART_STARK_VK_ATTESTATION: &str =
        "/v1/proofs/part_stark_vk_attestations";
    pub(crate) const PROOFS_PART_STARK_VK_ATTESTATION_ANCHOR: &str =
        "/v1/proofs/part_stark_vk_attestations/{batch_id}/bitcoin_anchor";
